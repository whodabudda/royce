...
class DrawingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drawing" do
    assert_difference('Drawing.count') do
      post drawings_url, params: { drawing: { comment: @drawing.comment, created_on_date: @drawing.created_on_date, moniker: @drawing.moniker, picture: @drawing.picture, title: @drawing.title } }
    end
  ...
  test "should update drawing" do
    patch drawing_url(@drawing), params: { drawing: { comment: @drawing.comment, created_on_date: @drawing.created_on_date, moniker: @drawing.moniker, picture: @drawing.picture, title: @drawing.title } }
